...
final class CurrentDirectoryTests: XCTestCase {
    ...
    func testCurrentDirectoryCommand() throws {
        ...
        XCTAssertEqual(try system(command: "cat foo-command", captureOutput: true, currentDirectoryPath: "/tmp").standardOutput, content)
    }
    ...
    func testCurrentDirectoryShell() throws {
        ...
        XCTAssertEqual(try system(shell: "cat foo-shell", captureOutput: true, currentDirectoryPath: "/tmp").standardOutput, content)
    }
